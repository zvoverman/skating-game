...
var ChunkScene: PackedScene = preload("res://project/scenes/chunk.tscn")
var ChunkNoObstacleScene: PackedScene = preload("res://project/scenes/chunk_no_obstacles.tscn")
var chunks: Array = [];
